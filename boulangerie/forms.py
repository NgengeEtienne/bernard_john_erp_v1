...
from .models import BoulangerieCustomer,BoulangerieProductSubCategory

class BoulangerieCustomerForm(forms.ModelForm):
    class Meta:
...
class BoulangerieProductCategoryForm(forms.ModelForm):
    class Meta:
...
from django import forms
from .models import BoulangerieInvoice, BoulangerieInvoiceDetail

class BoulangerieInvoiceForm(forms.ModelForm):
    class Meta:
...
class BoulangerieInvoiceDetailForm(forms.ModelForm):
    class Meta:
...
BoulangerieInvoiceDetailFormSet = formset_factory(BoulangerieInvoiceDetailForm, extra=1)



from .models import BoulangeriePurchase, BoulangeriePurchaseItems

class BoulangeriePurchaseForm(forms.ModelForm):
    class Meta:
...
class BoulangeriePurchaseItemsForm(forms.ModelForm):
    class Meta:
...
# FormSet for multiple BoulangeriePurchaseItems entries
BoulangeriePurchaseItemsFormSet = forms.modelformset_factory(
    BoulangeriePurchaseItems,
    form=BoulangeriePurchaseItemsForm,
    extra=1,
)


from .models import BoulangerieInventory, BoulangerieInventoryItems

class BoulangerieInventoryForm(forms.ModelForm):
    class Meta:
...
class BoulangerieInventoryItemsForm(forms.ModelForm):
    class Meta:
...
BoulangerieInventoryItemsFormSet = forms.modelformset_factory(
    BoulangerieInventoryItems,
    form=BoulangerieInventoryItemsForm,
    extra=1,
)
...
# #--------------------------- Production --------------------------------#
# class BoulangerieProductionForm(forms.ModelForm):
#     class Meta:
...
# class BoulangerieRawMaterialUsageForm(forms.ModelForm):
#     class Meta:
#         model = BoulangerieRawMaterialUsage
#         fields = [
#             'raw_material',
#             'qty',
#             'unit_cost_price'
...
# BoulangerieRawMaterialUsageFormSet = modelformset_factory(BoulangerieRawMaterialUsage, 
#                                                      form=BoulangerieRawMaterialUsageForm, extra=1)
# #--------------------------- / Production --------------------------------#
...
# from .models import BoulangerieProductionOutput  # Replace with your actual model name

# class BoulangerieProductionOutputForm(forms.ModelForm):
#     class Meta:
#         model = BoulangerieProductionOutput  # Replace with your actual model name
#         fields = [
...
# BoulangerieProductionOutputFormset = forms.modelformset_factory(
#     BoulangerieProductionOutput,
#     form=BoulangerieProductionOutputForm,
#     extra=1,
# )
...
from .views import WholesaleCustomerListView, WholesaleCustomerDetailView, WholesaleCustomerCreateView, WholesaleCustomerEditView
from .views import (
    WholesaleProductCategoryListView,
    WholesaleProductCategoryDetailView,
    WholesaleProductCategoryCreateView,
    WholesaleProductCategoryEditView,
    
    # WholesaleProductionListView,
    # WholesaleInventoryDetailView,
    #create_production,
)
from .views import (
    WholesaleCustomerOpeningBalanceListView,
    WholesaleCustomerOpeningBalanceCreateView,
    WholesaleCustomerOpeningBalanceUpdateView,
    # WholesaleReturnsItemsListView,
    # WholesaleReturnsItemsCreateView,
    # WholesaleReturnsItemsUpdateView,
)

from . import views
from .views import WholesaleProductListView, WholesaleProductCreateView, WholesaleProductUpdateView
...
urlpatterns = [
     path('', views.wholesale_view, name='wholesale'),

##Customers
    path('customers/', WholesaleCustomerListView.as_view(), name='customer'),
    path('customers/add/', WholesaleCustomerCreateView.as_view(), name='customer-add'),  # New URL for adding customers
    path('customers/<slug:slug>/', WholesaleCustomerDetailView.as_view(), name='customer-detail'),  # Detail view URL
    path('edit/<slug:slug>/', WholesaleCustomerEditView.as_view(), name='customer-edit'),  # Edit customer URL
    
 ##Categories
    path('categories', WholesaleProductCategoryListView.as_view(), name='category-list'),
    path('categories/<int:pk>/', WholesaleProductCategoryDetailView.as_view(), name='category-detail'),
    path('categories/add/', WholesaleProductCategoryCreateView.as_view(), name='category-create'),
    path('categories/edit/<int:pk>/', WholesaleProductCategoryEditView.as_view(), name='category-edit'),
    ...
    #Products
    path('products/', WholesaleProductListView.as_view(), name='product-list'),
    path('products/add/', WholesaleProductCreateView.as_view(), name='product-add'),
    path('products/edit/<int:pk>/', WholesaleProductUpdateView.as_view(), name='product-edit'),
    ...
    # path('inventories/<int:pk>/', WholesaleInventoryDetailView.as_view(), name='inventory-detail'),
    # ... other invoice-related URLs
 
    # Production
#     path('production/', WholesaleProductionListView.as_view(), name='production'),
...
#     path('recipe-raw-material/edit/<int:pk>/', RecipeRawMaterialUpdateView.as_view(), name='reciperawmaterial-edit'),
    ...
    path('customer-opening-balance/', WholesaleCustomerOpeningBalanceListView.as_view(), name='customer-opening-balance-list'),
    path('customer-opening-balance/add/', WholesaleCustomerOpeningBalanceCreateView.as_view(), name='customer-opening-balance-add'),
    path('customer-opening-balance/edit/<int:pk>/', WholesaleCustomerOpeningBalanceUpdateView.as_view(), name='customer-opening-balance-edit'),

    # Customer Return Items
    # path('return-items/', WholesaleReturnsItemsListView.as_view(), name='customer-return-items-list'),
    # path('add-returns/', views.add_returns_view.as_view(), name='customer-return-items-add'),
    # path('customer-return-items/edit/<int:pk>/', WholesaleReturnsItemsUpdateView.as_view(), name='customer-return-items-edit'),
